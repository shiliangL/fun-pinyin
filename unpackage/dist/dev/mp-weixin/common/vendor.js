...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"儿童拼音学习","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!***************************************!*\
  !*** C:/shiliangL/fast-yk/pages.json ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 32 */
/*!********************************************************!*\
  !*** C:/shiliangL/fast-yk/pages.json?{"type":"style"} ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    // 更新学习进度
    UPDATE_LEARNING_PROGRESS: function UPDATE_LEARNING_PROGRESS(state, payload) {
      state.learningProgress = _objectSpread(_objectSpread({}, state.learningProgress), payload);
    },
    // 更新游戏数据
    UPDATE_GAME_DATA: function UPDATE_GAME_DATA(state, payload) {
      state.gameData = _objectSpread(_objectSpread({}, state.gameData), payload);
    },
    // 更新成就
    UPDATE_ACHIEVEMENTS: function UPDATE_ACHIEVEMENTS(state, payload) {
      state.achievements = _objectSpread(_objectSpread({}, state.achievements), payload);
    }
  },
  actions: {
    // 记录学习进度
    recordProgress: function recordProgress(_ref, payload) {
      var commit = _ref.commit;
      commit('UPDATE_LEARNING_PROGRESS', payload);
    },
    // 更新游戏分数
    updateGameScore: function updateGameScore(_ref2, payload) {
      var commit = _ref2.commit;
      commit('UPDATE_GAME_DATA', payload);
    },
    // 记录每日登录
    recordDailyLogin: function recordDailyLogin(_ref3) {
  ...
  getters: {
    // 获取学习进度
    learningProgress: function learningProgress(state) {
      return state.learningProgress;
    },
    // 获取游戏数据
    gameData: function gameData(state) {
...
/* 119 */
/*!********************************************************************************************!*\
  !*** C:/shiliangL/fast-yk/uni_modules/uni-icons/components/uni-icons/uniicons_file_vue.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
