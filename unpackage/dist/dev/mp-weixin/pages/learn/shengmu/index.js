...
const _sfc_main = {
  data() {
    return {
      pinyinList: ["b", "p", "m", "f", "d", "t", "n", "l", "g", "k", "h", "j", "q", "x", "zh", "ch", "sh", "r", "z", "c", "s", "y", "w"],
      currentPlaying: null,
      loading: null,
      audioContext: null
    };
  ...
  methods: {
    playAudio(pinyin) {
      ...
      this.audioContext.onError((err) => {
        common_vendor.index.__f__("error", "at pages/learn/shengmu/index.vue:59", "Audio error:", err);
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/learn/shengmu/index.js.map
